...
public static class ObjectPropertyExtensions
{
    ...
    /// <summary>Try to get the value of a property of an object
    /// 
    /// </summary>
    /// <typeparam name="T">The expected type of the value</typeparam>
    /// <param name="obj">The object containing the property whose value will be retrieved</param>
    /// <param name="propertyName">The name of the property whose value will be retrieved</param>
    /// <param name="val">The value that was retrieved if successful; default(T) otherwise</param>
    /// <param name="msg">Any message associated with a failure to retrieve the value; "" otherwise</param>
    /// <returns><c>true</c> if the value was successfully retrieved; <c>false</c> otherwise</returns>
    ...
    /// <summary>Tries to set the value of a named property of an object
    /// 
    /// </summary>
    /// <typeparam name="T"></typeparam>
    /// <param name="obj">The object whose property will be set to the value</param>
    /// <param name="propertyName">The name of the property that will be set to the value</param>
    /// <param name="value">The value that will be set</param>
    /// <param name="msg">Any error message associated with a failure to set the value</param>
